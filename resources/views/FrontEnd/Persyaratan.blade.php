    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <!--kotak-->
                <div class="kotak1" >
                  ...
                  <!--akhir kotak-->
                   <button type="button home-button" id="button1" > <a href="/Deskripsi" style="color: black;">Deskripsi Pekerjaan</a> </button>
                   <button type="button contact-button" id="button1"> <a href="/Persyaratan" style="color: black;" > <strong> Persyaratan </strong> </a> </button>
                  <div>
                    <h1> Persyaratan
                    </h1>
                    <h2>
